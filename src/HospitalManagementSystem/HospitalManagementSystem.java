            ...
            while(true){
                ...
                if (accountType.equals("maindoctor")) {
                    ...
                    while(true) {
                        ...
                        System.out.println("====================================");
                        System.out.println(" ");
                        System.out.println("Greetings, dear, MainDoctor! ");
                        System.out.println("Please dial the menu number to work with the program,");
                        System.out.println("if finished, then dial 4:");
                        System.out.println("+--------------+");
                    ...
                    while(true) {
                        ...
                        System.out.println("====================================");
                        System.out.println(" ");
                        System.out.println("Greetings, dear, Doctor! ");
                        System.out.println("Please dial the menu number to work with the program,");
                        System.out.println("if finished, then dial 3:");
                        System.out.println("+---------------+");
                    ...
                    while(true){
                        ...
                        System.out.println("====================================");
                        System.out.println();
                        System.out.println("Greetings, dear, Nurse! ");
                        System.out.println("Please dial the menu number to work with the program,");
                        System.out.println("if finished, then dial 4:");
                        System.out.println("+-------------------------+");
                    ...
                    while(true){
                        ...
                        System.out.println("====================================");
                        System.out.println();
                        System.out.println("Greetings, dear, Patient! ");
                        System.out.println("Please dial the menu number to work with the program,");
                        System.out.println("if finished, then dial 3:");
                        System.out.println("+-----------------------+");
